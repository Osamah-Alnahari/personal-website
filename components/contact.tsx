      ...
      <div className="max-w-7xl 3xl:max-w-8xl 4xl:max-w-9xl 5xl:max-w-10xl mx-auto px-4 sm:px-6 lg:px-8 3xl:px-12 4xl:px-16 5xl:px-20">
        <div className="text-center mb-12 md:mb-16 3xl:mb-20 4xl:mb-24">
          ...
          <p className="text-lg xs:text-xl 3xl:text-2xl 4xl:text-3xl text-muted-foreground max-w-3xl 3xl:max-w-4xl 4xl:max-w-5xl mx-auto gsap-fade-up text-pretty leading-relaxed">
            ...
            work together to build innovative solutions with modern
            technologies.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 3xl:grid-cols-5 gap-8 md:gap-12 3xl:gap-16 4xl:gap-20">
          ...
          <div className="gsap-fade-left 3xl:col-span-2">
            ...
            <div className="space-y-4 md:space-y-6 3xl:space-y-8 mb-6 md:mb-8 3xl:mb-10">
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-3 sm:space-x-4 3xl:space-x-6"
                >
            ...
            <div className="glass-morphism bg-gradient-to-br from-primary/5 to-accent/5 p-4 sm:p-6 3xl:p-8 4xl:p-10 rounded-xl professional-shadow">
              ...
              <p className="text-sm sm:text-base 3xl:text-lg 4xl:text-xl text-muted-foreground">
                ...
                freelance projects. Let's discuss how we can work together on
          ...
          {/* Contact Form */}
          <Card className="gsap-fade-right 3xl:col-span-3 glass-morphism professional-shadow hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 border-border/30">
